...
export function parseWhatsAppMessage(message) {
  ...
  try {
    ...
    const [dateTimePart, rest] = message.split(" - ");

    if (!dateTimePart.includes(", ")) return null;
    ...
    const sender = rest.slice(0, firstColonIndex);
    const text = rest.slice(firstColonIndex + 2);
